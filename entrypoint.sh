...
# Display IP
IPAD=$(ip a s eth0 | grep -E -o 'inet [0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' | cut -d' ' -f2)
echo "Welcome to Kali! Your Docker IP address is: $IPAD"
echo "Launch your web browser and open https://$IPAD:$NOVNCPORT/vnc.html"
